    ...
    <div class="dropdown">
        ...
        <div class="sub__content">
            <div class="wrap">
                ...
                <div class="sub__tabs">
                    <a href="" class="active">DIP 소개</a>
                    <a href="">DIP 협약기관 현황</a>

                    <div class="select">
                        <select name="" id="">
                            <option value="">DIP 소개</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="process">
                <div class="box box1">
                    <div class="wrap">
                        ...
                        <div class="img"><img src="./assets/images/dip1.png" alt="" class="inline-block"></div>
                    </div>
                </div>
                <div class="box box2">
                    <div class="wrap">
                    ...
                    <div class="wrap">
                        ...
                        <div class="list flex">
                            <div class="item">
                                ...
                                <img src="./assets/images/i-dip1.png" alt="" class="img">
                                <div class="txt">
                                    <p>
                            ...
                            <div class="item">
                                ...
                                <img src="./assets/images/i-dip2.png" alt="" class="img">
                                <div class="txt">
                                    <p>
                            ...
                            <div class="item">
                                ...
                                <img src="./assets/images/i-dip3.png" alt="" class="img">
                                <div class="txt">
                                    <p class="dots mint">
