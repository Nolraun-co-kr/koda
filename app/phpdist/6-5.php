          ...
          <div class="sub__content">
            ...
            <div class="wrap">
              ...
              <div class="info__content">
                <div class="tab-area">
                  <div class="tabBtn flex type2">
                    <a href="" class="active">정보공개제도 안내</a>
                    <a href="">정보공개 청구</a>
                  </div>
                  <div class="tabCont">
                    <div class="tabItem">
                      <div class="box">
                        <div class="top-txtBox flex items-center">
                          <div class="img">
                            <img
                              src="./assets/images/info-top-img1.png"
                              alt=""
                              class=""
                            />
                          </div>
                          <div class="txt">
                            ...
                            <p>
                              정보공개제도란 한국장기조직기증원이 직무상 작성
                              또는 취득하여 관리하고 있는 정보를 수요자인 국민의
                              청구에 의하여<br />
                              열람·사본·복제 등의 형태로 청구인에게 공개하거나
                              한국장기조직기증원이 자발적으로 또는 법령 등의
                              규정에 의하여 의무적<br />
                              으로 보유하고 있는 정보를 배포 또는 공표 등의
                              형태로 제공하는 제도를 시행하고 있습니다.
                            </p>
                          </div>
                        </div>
                      ...
                      <div class="box">
                        ...
                        <div class="boxflex flex text-center">
                          <div class="col flex-1 mr-10">
                            ...
                            <p>
                              한국장기조직기증원이 직무상 작성 또는 취득하여
                              관리하고 있는 정보를<br />
                              청구인의 청구에 의하여 공개하는 제도입니다. (예 :
                              공문서의 열람, 복사청구 등)
                            </p>
                          </div>
                          <div class="col flex-1">
                            ...
                            <p>
                              정보를 보유한 한국장기조직기증원이 자발적으로 또는
                              법령상 의무적으로 정보를<br />
                              제공하는 제도입니다. (예 : 인터넷을 통한 정보
                              제공, 간행물의 배포 등)
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="scrollbox">
                          <div class="table border-orange infoTable type2">
                            <table>
                              ...
                              <tbody>
                                <tr>
                                  <td class="font-bold bg-gray">
                                    정보공개 대상 정보
                                  </td>
                                  <td class="font-medium text-left" colspan="2">
                                    한국장기조직기증원이 직무상 작성 또는
                                    취득하여 관리하고 있는 문서(전자 문서를
                                    포함)도면, 사진, 필름, 테이프, 슬라이드 및
                                    컴퓨터에 의하여 처리되는 매체 등에 기록된
                                    사항
                                  </td>
                                </tr>
                                <tr>
                                  <td class="font-bold bg-gray" rowspan="2">
                                    정보공개 청구권자
                                  </td>
                      ...
                      <div class="">
                        ...
                        <div class="mb-16">
                          <h4 class="mb-4 txt-style-orange">
                            정보공개 책임 담당자
                          </h4>
