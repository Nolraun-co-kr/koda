        ...
        <div class="sub__visual">
            <div class="sub__pagename">
                <div class="wrap">
                    <h2>기증희망등록</h2>
                    <p>함께해요! 기증희망등록</p>
                    <img class="img" src="./assets/images/sub-visual4.png" alt="">
                </div>
            </div>
    ...
    <div class="dropdown">
        ...
        <div class="sub__content">
            ...
            <div class="register__content">
                ...
                <div class="wrap">
                    <div class="sub__tabs">
                        <a href="" class="active">기증희망등록이란?</a>
                        <a href="">기증희망등록 신청하기</a>


                        <div class="select">
                            <button>기증희망등록이란?</button>
                            <div class="dropdown">
                                <a href="" class="">기증희망등록이란?</a>
                                <a href="">기증희망등록 신청하기</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                            ...
                            <div class="wrap flex justify-center">
                                <div class="item item1">
                                    <a href="#quickMove" class="">
                                        <img src="./assets/images/laptop.png" alt="" class="img">
                                        <p>온라인</p>
                                    </a>
                                </div>
                                <div class="item item2">
                                    <a href="#quickMove" class="">
                                        <img src="./assets/images/mail.png" alt="" class="img">
                                        <p>우편</p>
                                    </a>
                                </div>
                                <div class="item item3">
                                    <a href="#quickMove" class="">
                                        <img src="./assets/images/fax.png" alt="" class="img">
                                        <p>팩스</p>
                                    </a>
                                </div>
                                <div class="item item4">
                                    <a href="#quickMove" class="">
                                        <img src="./assets/images/phone2.png" alt="" class="img">
                                        <p>방문상담</p>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="row notify">
                            <div class="wrap text-center">
                                ...
                                <img src="./assets/images/register1-2.png" alt="" class="img inline-block">
                                <p>
                        ...
                        <div class="row details">
                            <div class="wrap">
                                <div class="tit">
                                    <p><img src="./assets/images/register-calligraphy.png" alt="" class=""></>
                                    <p class="mt-4">1인 1개 <strong>기증희망등록카드 갖기</strong> 운동!</p>
                                </div>
                                <div class="img text-center" id="quickMove">
                                    <img src="./assets/images/register1-4.png" alt="" class="inline-block">
                                </div>
                                <div class="linksBox">
                                    <div class="row">
