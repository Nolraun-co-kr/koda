            ...
            <div class="wrap">
              <div class="sub__header">
                ...
                <div class="top-txtBox flex items-center">
                  <div class="img">
                    <img src="./assets/images/story-top-img.png" alt="" />
                  </div>
                  <div class="txt">
                    <h3 class="flex items-center">
                      <span>가슴 따뜻해지는 생명 나눔 이야기</span>를
                      소개합니다.
                    </h3>
                    <p>
                      생명 나눔을 실천한 고귀한 분들의 이야기, 장기 수혜를 통해
                      새 삶을 얻은 감동 스토리를 소개합니다.<br />
                      생명나눔 스토리를 통해 장기·조직 기증의 진짜 의미를
                      되새겨보시길 바랍니다.
                    </p>
                  </div>
                </div>
              ...
              <div class="promote__select flex ml-auto">
                <select name="" id="">
                  ...
                  <option value="" selected>생명나눔 스토리</option>
                </select>
              </div>
                  ...
                  <div class="item">
                    <a href="" class="inline-block">
                      <div class="imgBox">
                        <div class="img">
                          <img
                            src="./assets/images/publication-bg3.png"
                            alt=""
                          />
                        </div>
                      </div>
